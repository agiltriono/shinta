module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (interaction.isButton()) {
      ...
      if (interaction.customId.includes('imut_game_button_')) return go("game", "game/game", interaction.customId.replace("imut_game_button_", ""));
    }
    if (interaction.isSelectMenu()) {
      ...
      if (interaction.customId.includes('imut_game_selectmenu_')) return go("game", "game/game", helper(interaction.customId.replace("imut_game_selectmenu_", '')));
    }

// Allow user to store their settings localy without dealing with request
// @params CLIENT.assign(OBJECT | STRING, OBJECT | STRING, OBJECT)
// @params CLIENT.exist(OBJECT | STRING, OBJECT)
// @params CLIENT.get(OBJECT | STRING)
// @params CLIENT.update(OBJECT | STRING, OBJECT)
// @params CLIENT.delete(OBJECT | STRING)

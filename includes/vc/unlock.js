...
module.exports.execute = async function(interaction, client) {
  ...
  if (ghost === true) return interaction.editReply(ephemeral(`⚠️ Tidak dapat menggunakan **UNLOCK** ketika channel dalam keadaan tersembunyi, Gunakan **UNHIDE** terlebih dahulu.`));
